...
@section('content')
    ...
    <div class="box">
        <div id="div_message" class="mt-1 alert alert-warning alert-dismissible fade show in text-center"
             style="display: none">
            <div id="message"></div>
                    ...
                    <div class="mt-1 row">
                        ...
                        <div class="col-sm-7">
                            ...
                            <select name="Organization" id="select_Organization" class="form-select text-black"
                                    onchange="Organization_PaymentAccount(this.value)">{{--onclick="PaymentAccountFun()" >--}}
                            ...
                            <div class="col-7">
                                @foreach($arr_PaymentAccount as $id=>$arr_item)
                                    <div id="PaymentAccount_{{$id}}" style="display: none">
                                        <select id="select_PaymentAccount_{{$id}}" name="{{$id}}"
                                                class="form-select text-black">
                                            @if(($arr_item) != [])
                                                @foreach($arr_item as $item)
                                                    <option
                                                        value="{{$item->accountNumber}}"> {{$item->accountNumber}} </option>
                                                @endforeach
                                            @else
